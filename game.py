...
class naveEspacial(pygame.sprite.Sprite):
    ...
    DISPARO_DELAY = 50 # Para poder tener un tiempo intermedio entre cada disparo
...
class Misil(pygame.sprite.Sprite):
    ...
    def __init__(self, posx, posy):
        ...
        self.velocidad_min = 6 # Establecemos una velocidad minima del misil
        
        self.velocidad_max = 10 # Estabblecemos una velocidad máxima del misil
...
def juego(record=None):
    ...
    caida_bonus = 1800 # Establece cada cuanto aparece el bonus en la pantalla de nuestro juego
    ...
    while iniciar:
        ...
        texto_cohetes_destruidos = texto_enjuego.render('Cohetes destruidos:{}'.format(len(contador_misiles_destruidos)), 1, (151,151,151)) # Pintamos el contador de misiles destruidos dentro de nuestra ventana
        VENTANA.blit(texto_cohetes_destruidos, (10,100))
